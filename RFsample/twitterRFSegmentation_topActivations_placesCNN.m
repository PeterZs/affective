...
features_folder = '/imatge/vcampos/work/twitter_dataset/feature_maps_places_mat/test1/conv5/';
ground_truth_file = '/imatge/vcampos/work/twitter_dataset/feature_maps_places_mat/test1.txt';
...
for j=1:+N_images
    ...
    imwrite(curSegmentation, ['/imatge/vcampos/work/RF_results/placesCNN/unit' num2str(unitID) '_' num2str(j) '.jpg']);
end
